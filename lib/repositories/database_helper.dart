...
String createTableProdutos =
    'CREATE TABLE produtos (id INTEGER PRIMARY KEY AUTOINCREMENT, codigo_de_barras TEXT,  titulo_do_produto TEXT, valor_de_custo REAL, valor_de_venda REAL, quantidade_de_estoque REAL, marca_id INTEGER, data_hora_criacao DATETIME, data_hora_modificacao DATETIME, data_hora_sincronizacao DATETIME, FOREIGN KEY (marca_id) REFERENCES marcas(id));';
